...
# Slightly modified "solarized" theme for pudb
# ============================================
#
...
# Looks best in iTerm2 with light solarized color theme.
#
# ATTENTION: Be sure to set 'raw' terminal driver in pudb's settings
...
palette.update({
    ...
    "current source": ("h231", "h211"),
    "current focused source": ("h231", "h140"),

    "focused source": ("dark gray", "h69"),
